...

{
    ...
    'author': "BROWSEINFO",
    'website': 'https://www.browseinfo.com/demo-request?app=bi_crm_claim&version=18&edition=Community',
    ...
    'application': True,
    'auto_install': False,
    'live_test_url':'https://www.browseinfo.com/demo-request?app=bi_crm_claim&version=18&edition=Community',
